...
# The R package lives at <bundle>/microTransfer, i.e. one level up from scripts/.
# (was ${SCRIPT_DIR}/../.. which wrongly pointed at the bundle's PARENT dir.)
PACKAGE_DIR="$(cd "${SCRIPT_DIR}/.." && pwd)/microTransfer"
